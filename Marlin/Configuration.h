...
#define STRING_CONFIG_H_AUTHOR "(pechotes, alicates, correos, yakandu et al.)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Any 1.1.9"
...
#define DELTA
  ...
  #define DELTA_RADIUS 134.0 //mm  Get this value from auto calibrate
